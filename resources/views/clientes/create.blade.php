                ...
                <form action="{{ route('clientes.store') }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="nome" class="form-control" placeholder="Ex: Peter Parker" required>
                        </div>
                        <div class="col-md-6 mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="medidas_corpo" class="form-control" rows="3" placeholder="Ex: Altura 1.80, Peso 75kg, Ombro 45cm..."></textarea>
                        <small class="text-muted">Importante para ajustes de fatos/cosplays.</small>
                    </div>

                    <div class="d-flex justify-content-between">
                        <a href="{{ route('clientes.index') }}" class="btn btn-secondary">Cancelar</a>
                        <button type="submit" class="btn btn-dark px-4">Salvar Cliente</button>
                    </div>
                </form>
            </div>
        </div>
